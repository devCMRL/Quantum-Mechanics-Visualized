...
| Ch. | Topic |
|---:|--------|
| 1 | Five postulates (roadmap) |
| 2 | Finite-dimensional Hilbert space |
| 3 | Born rule and measuring an observable |
| 4 | Pauli observables and expectation values |
| 5 | Uncertainty for Pauli σx and σz |
| 6 | Gaussian wavepacket in 1D |
| 7 | Infinite square well |
| 8 | Harmonic oscillator |
| 9 | Rectangular barrier |
| 10 | Potential step |
